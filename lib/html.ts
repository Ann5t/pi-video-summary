...
<footer>Generated by pi video-summary · whisper(${esc(data.whisperModel)} @ ${esc(data.whisperDevice)})<br>模型: 文本(校对+总结) ${esc(data.proofreadModel)} · 画面 ${esc(data.visionModel)}<br>${esc(data.generatedAt.toISOString())}</footer>
</div>
</body>
</html>
`;
